...
1. Read the clone pack JSON from `{origin}/api/v1/clone/{handle}` or the prompt on `{origin}/{handle}/clone`.
2. Create Grok Bots with those names and roles. Use the standing orders as the starting brief.
