  ...
  return (
    <div className="flex items-center gap-2">
      {user.profileImageUrl ? (
        ...
        <span className="grid h-8 w-8 place-items-center rounded-full bg-bg-subtle text-sm font-medium text-fg">
      ...
      {authEnabled && (
        <button
          ...
          className="cursor-pointer text-sm text-fg-muted underline-offset-4 hover:text-fg hover:underline"
        >
          Sign out
        </button>
      )}
