...
| **E1** | Outcome Contract object + public header                           | S2 live (or Hall shows SPX404) | HIGH     | shipped | BRAIN `buyer_04`, `buyer_10`         |
...
- [x] E1 — persistent Outcome Contract header + authenticated poster history (SPX404; no market actions)
